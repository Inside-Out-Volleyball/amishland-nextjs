    ...
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {locations.map((loc) => (
            <div key={loc.name} className="bg-white border-2 border-pink-200 rounded-xl shadow-xl p-6 flex flex-col gap-4">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h2 className="text-2xl font-bold text-pink-900">{loc.name}</h2>
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full border border-pink-200 text-pink-700 hover:bg-pink-50 hover:border-pink-300 p-2 focus:outline-none focus:ring-2 focus:ring-pink-300"
                >
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="grid grid-cols-1 border-2 border-pink-300 rounded-lg overflow-hidden">
                  <div className="p-3 bg-pink-50 font-bold text-pink-900">Seating</div>
                ...
                <div className="grid grid-cols-1 border-2 border-pink-300 rounded-lg overflow-hidden">
                  <div className="p-3 bg-pink-50 font-bold text-pink-900">Apparel</div>
                  <div className="p-3 bg-white text-gray-800">
                    <div className="flex items-start gap-2">
                ...
                <div className="grid grid-cols-1 border-2 border-pink-300 rounded-lg overflow-hidden">
                  <div className="p-3 bg-pink-50 font-bold text-pink-900">Concessions</div>
                  <div className="p-3 bg-white text-gray-800">
                    <div className="flex items-start gap-2">
